var layer, form, laydate, flow, laypage;
layui.use([ 'layer', 'form', 'laydate', 'flow', 'laypage' ], function () {
    layer = layui.layer, form = layui.form, laydate = layui.laydate, flow = layui.flow, laypage = layui.laypage;
})
